...
from config import API_HASH_PREMIUM, API_ID_PREMIUM, PHONE_PREMIUM
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("../botPremium.log"),  # Log to a file
...
api_id = API_ID_PREMIUM
api_hash = API_HASH_PREMIUM
phone = PHONE_PREMIUM
...
with TelegramClient("telethonMessageForwardPremiumBot", api_id, api_hash) as client:
    # Helper function to replace text
    mediaGroup_1 = []
    is_media_group = False

    premium_channel = [-1002227848813]
